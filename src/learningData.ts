import { stageLearningActivities } from './stageLearning';
...
export const learningAgeGroups: LearningAgeGroup[] = [
  ...
  { id: 'bigkid', label: 'Big Kid', range: '6–8 years', emoji: '🧩' },
...
export const learningActivities: LearningActivity[] = [
  ...
  makeActivity('laundry-sort', 'Sort the Laundry', '🧺', 'thinking', '5 min', 'No prep', 'Indoor', 'low',
    ...
    ['Invite your child to make two or three groups.', 'Let them choose the sorting rule.', 'Name the pattern together.'], ['toddler', 'preschool']),
  makeActivity('sock-match', 'Match the Socks', '🧦', 'thinking', '10 min', 'No prep', 'Indoor', 'low',
    ...
    'Clean socks',
    ['Make a mixed pile.', 'Find matching pairs together.', 'Let your child explain how they know a pair matches.'], ['toddler', 'preschool']),
  makeActivity('story-bag', 'Tell a Three-Item Story', '📚', 'language', '10 min', 'No prep', 'Indoor', 'low',
    ...
    ['Choose three objects.', 'Start a simple story.', 'Let your child add what happens next.'], ['preschool']),
  makeActivity('sound-hunt', 'Sound Hunt', '👂', 'language', '5 min', 'No prep', 'Both', 'medium',
    ...
    'Nothing',
    ['Pause and listen.', 'Name sounds you hear.', 'See whether your child can find the source.'], ['toddler', 'preschool']),
  makeActivity('cushion-path', 'Cushion Path', '🛋️', 'motor', '10 min', 'Quick prep', 'Indoor', 'high',
    ...
    ['Create a short path.', 'Walk, step, or crawl across.', 'Change one part and try again.'], ['toddler', 'preschool']),
  makeActivity('water-pour', 'Pour and Transfer', '💧', 'motor', '10 min', 'Quick prep', 'Both', 'medium',
    ...
    ['Set up a small safe work area.', 'Pour from one cup to another.', 'Try different containers if your child enjoys it.'], ['toddler', 'preschool']),
  makeActivity('pretend-store', 'Pretend Grocery Store', '🛒', 'social', '20+ min', 'No prep', 'Indoor', 'medium',
    ...
    ['Set up a tiny store.', 'Take turns being shopper and cashier.', 'Let your child invent the rules.'], ['toddler', 'preschool']),
  makeActivity('build-explain', 'Build and Explain', '🧩', 'thinking', '20+ min', 'No prep', 'Indoor', 'medium',
    ...
    ['Build something together.', 'Ask your child to explain the plan.', 'Try one small change and see what happens.'], ['preschool']),
  makeActivity('cleanup-job', 'Give One Real Job', '🌱', 'independence', '5 min', 'No prep', 'Indoor', 'low',
    ...
    ['Choose one concrete job.', 'Show it once.', 'Step back and let your child try.'], ['toddler', 'preschool']),
  makeActivity('nature-notice', 'Notice Five Things', '🌿', 'creativity', '10 min', 'No prep', 'Outdoor', 'medium',
    ...
    'Nothing',
    ['Find five things that are different.', 'Describe one detail about each.', 'Let your child choose the next thing to notice.'], ['toddler', 'preschool']),
  makeActivity('freeze-dance', 'Freeze Dance', '🎵', 'motor', '5 min', 'No prep', 'Indoor', 'high',
    ...
    'Music',
    ['Play music.', 'Move while it plays.', 'Pause the music and freeze.'], ['toddler', 'preschool']),
  makeActivity('feelings-faces', 'Make Feeling Faces', '🙂', 'social', '5 min', 'No prep', 'Indoor', 'low',
    ...
    'Nothing',
    ['Name a simple feeling.', 'Make a face for it.', 'Ask when someone might feel that way.'], ['toddler', 'preschool']),
  makeActivity('independent-bin', 'Independent Play Basket', '🧺', 'creativity', '20+ min', 'Quick prep', 'Indoor', 'low',
    ...
    ['Put out a small selection.', 'Tell your child they can choose what to do.', 'Stay nearby without directing every step.'], ['toddler', 'preschool']),
  makeActivity('read-and-point', 'Read and Point', '📖', 'language', '5 min', 'No prep', 'Indoor', 'low',
    ...
    'A favorite book',
    ['Read one short book.', 'Pause to name pictures.', 'Let your child point, comment, or turn pages.'], ['toddler', 'preschool']),
  makeActivity('count-snacks', 'Count the Snacks', '🍓', 'thinking', '5 min', 'No prep', 'Indoor', 'low',
    ...
    'Snack pieces',
    ['Put out a few pieces.', 'Count them together.', 'Ask how many there would be with one more.'], ['preschool']),
];
...
const buildPlan = (ageId: string, focusArea: LearningCategory, childName?: string, childId?: number | null): LearningPlan => {
  ...
  return {
    ...
    plan: selected.map((activity, i) => ({
      ...
      harder: ageId === 'baby' ? 'Repeat only while your baby is interested; a look or sound is enough.' : ageId === 'toddler' ? 'Model one new word or one extra step if your child is interested.' : 'Add one small challenge or invite your child to explain their thinking.',
      activity,
    })),
  };
};
